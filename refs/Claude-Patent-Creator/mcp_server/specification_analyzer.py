...
class SpecificationAnalyzer(BaseAnalyzer):
            ...
            if not support_paras:
                ...
                self.issues.append(
                    SupportIssue(
                        ...
                        legal_ref="MPEP 2163 (35 USC 112(a) written description)",
                    )
                )
                    ...
                    if not support_paras:
                        self.issues.append(
                            SupportIssue(
                                ...
                                legal_ref="MPEP 2164 (35 USC 112(a) enablement)",
                            )
                        )
    ...
    def _calculate_coverage(self, claims: list[dict]) -> dict:
        ...
        claims_with_critical = {i.claim_number for i in self.issues if isinstance(i, SupportIssue) and i.severity == "CRITICAL"}  # type: ignore[attr-defined]
