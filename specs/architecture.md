...
- R13 compute/landing split + WebDAV 邊界(plan `patentmcp_webdav-r13-refactor`, 2026-07):
  ...
  - **測試**:`tests/test_dav.py`/`test_cache_tools.py`/`test_token_store_cache.py`/`test_screening_build.py`/`test_vendor_sync.py`;全套 136 passed。spec package:`specs/patentmcp_webdav-r13-refactor/`(已畢業 living)。
